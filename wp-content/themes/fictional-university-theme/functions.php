...
function university_files() {
  ...
  wp_localize_script('main-university-js', 'universityData', array(
    ...
    'nonce' => is_user_logged_in() ? wp_create_nonce('wp_rest') : null, // Only set nonce if logged in
...
function makeNotePrivate($data, $postarr) {
  ...
  if($data['post_type'] == 'note') {
    ...
    // count_user_posts(GET THE USER ID, 'WHAT POST TYPE' > 4) - if user has more than 4 notes
    // !$postarr['ID'] - true if ID do not exist/incoming
    ...
    // sanitize_textarea_field() - sanitize the textarea field - remove unwanted characters
    // sanitize_text_field() - sanitize the text field - remove unwanted characters
